    ...
    def escribir_archivo_salida(self):
        ...
        for k in range(self.matrix.size):
            ...
            for p in range(int(grupo)):
                ...
                child_tiempos.text = 'Hola ' + str(columna) # Aquí añadir los grupos con los nombres creados
        ...
        r_tring = ElementTree.tostring(top, 'utf-8')
        reparsed = minidom.parseString(r_tring)
